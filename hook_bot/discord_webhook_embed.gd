...
## Chainableᵗᵐ
func title(title: String) -> WebHookEmbed:
	embed["title"] = title
	return self


## Chainableᵗᵐ
func color(color: Color) -> WebHookEmbed:
	embed["color"] = DiscordWebHook.rgb_to_hex(color)
	return self


## Chainableᵗᵐ
func description(description: String) -> WebHookEmbed:
	embed["description"] = description
	return self


## Chainableᵗᵐ, highlights [param title] with the link color and makes the title clickable
func url(url: String) -> WebHookEmbed:
	embed["url"] = url
	return self


## Chainableᵗᵐ, [param timestamp] Must be a valid ISO8601 timestamp
func timestamp(timestamp: String) -> WebHookEmbed:
	embed["timestamp"] = timestamp
	return self


## Chainableᵗᵐ
func footer(text: String, icon_url := "") -> WebHookEmbed:
	embed["footer"] = {
...
## Chainableᵗᵐ
func thumbnail(url: String) -> WebHookEmbed:
	embed["thumbnail"] = {
		"url": url,
	}
	return self
